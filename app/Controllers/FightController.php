...
class FightController
{
    public function show($idChapitre)
    {
        ...
        $stmt = $db->prepare("SELECT to_chapter_id from Chapter_Choice WHERE from_chapter_id = :chapter AND (to_chapter_id <> 10 AND to_chapter_id <> 19 AND to_chapter_id <> 36 AND to_chapter_id <> 59 AND to_chapter_id <> 79)");
        $stmt->execute([':chapter' => $idChapitre]);
