...
<body class="font-['Roboto'] text-[#E5E5E5] bg-[#1A1A1A] min-h-screen flex flex-col">
    ...
    <div class="max-w-md mx-auto bg-[#2E2E2E] rounded-lg shadow-2xl p-8 border-2 border-[#C4975E]/30">
        <form action="signup" method="POST" class="max-w-md mx-auto">
            ...
            <p class="text-[#C4975E] text-xl">Choisissez votre genre :</p>
            <div class="flex flex-wrap mb-4">
            <label class="flex items-center gap-2 cursor-pointer w-[50%]">
                <input type="radio" name="gender" value="male" class="accent-[#C4975E]"  id="genre" required>
                <span class="text-[#C4975E]">Homme</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer w-[50%]">
                <input type="radio" name="gender" value="female" class="accent-[#C4975E]">
                <span class="text-[#C4975E]">Femme</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer w-[50%]">
                <input type="radio" name="gender" value="other" class="accent-[#C4975E]">
                <span class="text-[#C4975E]">Autre</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer w-[50%]">
                <input type="radio" name="gender" value="prefer_not_to_say" class="accent-[#C4975E]">
                <span class="text-[#C4975E]">Je préfère ne pas répondre</span>
            </label>
            </div>
    ...
    <script>
        ...
        genre_group.forEach(genre_item => {
            genre_item.addEventListener('change', function() {
            verifyForm();
        });
        });
