    ...
    <main class="flex justify-center">
        <div class="font-['Roboto'] text-3xl text-[#E5E5E5] mt-8">
            ...
            <div class="flex justify-center gap-4">
                <form action="UpdateProfilePage.php" method="post">
                    <input type="submit" value="Modifier" class=" bg-[#C4975E] m-auto hover:bg-[#8B1E1E] rounded-md p-2">
                </form>
                <form action="DeleteProfilePage.php" method="post">
                    <input type="submit" value="Supprimer" class=" bg-[#C4975E] m-auto hover:bg-[#8B1E1E] rounded-md p-2">
                </form>
            </div>
